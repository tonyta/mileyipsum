...
desc 'Scrapes azlyrics.com for all Miley Cyrus lyrics'
task :scrape do
  puts "Scraping Miley Cyrus lyrics..."
  require APP_ROOT.join('db', 'scrape.rb')
end

desc 'Parses through scraped html'
task :parse do
  puts 'Parsing...'
  require APP_ROOT.join('db', 'parse.rb')
end

task :line_length do
  require APP_ROOT.join('db', 'line_length.rb')
end
